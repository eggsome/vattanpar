...
KIND_COLORS = {  # matches src/draw.c
    ...
    "low":    (0x28 / 255, 0x2C / 255, 0x34 / 255),
    "medium": (0x41 / 255, 0x48 / 255, 0x57 / 255),
    "high":   (0x5D / 255, 0x66 / 255, 0x7B / 255),
}
WALL_EDGE_COLORS = {
    "low":    (0x3E / 255, 0x44 / 255, 0x50 / 255),
    "medium": (0x5A / 255, 0x62 / 255, 0x74 / 255),
    "high":   (0x7C / 255, 0x86 / 255, 0xA0 / 255),
}
